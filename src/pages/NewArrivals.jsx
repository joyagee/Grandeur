...
const NewArrivals = () => {
  ...
  useEffect(() => {
    if (productData) {
      ...
      const fewArrivals = arrivals.slice(0, 3);
      setFew(fewArrivals);
    }
  }, [productData]);
    ...
    <Layout>
      <div className="bg-primary flex justify-center flex-col min-h-screen mb-12">
        ...
        <div className="flex justify-center text-white mt-4 text-center lg:px-[10rem] md:px-[5rem] px-[2rem]">
          <p>
            Step into the latest trends — explore our newest arrivals crafted for style,
            comfort, and confidence. Fresh designs just landed!
          </p>
        </div>
        ...
        <div className="bg-white lg:pt-12 pt-2">
          ...
          <p className="text-center text-primary w-full mt-2 text-lg">
            Explore our freshest arrivals handpicked for you.
          </p>
          ...
          <div className="px-4 md:px-10 lg:px-20 grid w-full grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-8 md:gap-y-16 gap-16 justify-center items-stretch lg:mt-6 mt-8">
            {(fewDisplay ? few : newProducts)?.map((item) => (
              <div
                key={item.id}
                ...
                <div className="p-2">
                  ...
                  <div className="flex justify-between items-center mt-2">
                    ...
                    <div className="flex justify-between items-center gap-4">
                      ...
                      <span className="rounded-full p-2 cursor-pointer text-white bg-primary flex justify-center items-center">
